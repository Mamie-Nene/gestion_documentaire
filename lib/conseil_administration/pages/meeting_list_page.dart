...
class _ListReunionPageState extends State<ListReunionPage> {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {Navigator.of(context).pushNamed(AppRoutesName.addMeetingPage);},
                    child: Container(
                      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 12),
                      decoration: BoxDecoration(
                        color: AppColors.mainAppColor,
              ...
              const SizedBox(height: 16),
              TaskCardNew(context,
                title: "Réunion de mise en point",
              ),
  ...
  TaskCardNew(BuildContext context,{
    required String title,
  }) {
    return InkWell(
      borderRadius: BorderRadius.circular(AppDimensions.borderRadiusLarge),
                ...
                Flexible(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        //event date
                        Text(Helper().formatMonth( Helper().parseEventDate("2025-11-24")),
                            style: TextStyle( color: AppColors.mainEventsBlueColor, fontSize: 14,fontWeight: FontWeight.bold)),
                        Text(Helper().formatDay( Helper().parseEventDate("2025-11-24")),
                            style: TextStyle( color: AppColors.mainEventsBlueColor, fontSize: 16,fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
